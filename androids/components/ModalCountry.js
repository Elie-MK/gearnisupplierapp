import { View, Text, Modal, Pressable, TextInput, ScrollView, TouchableOpacity } from 'react-native'
...
const ModalCountry = ({value, isVisible, hideModal, setValue, onCountryChange}) => {
