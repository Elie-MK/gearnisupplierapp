    ...
    >
      ...
      <View style={{ marginLeft: 20, marginRight: 20, marginTop: 20 }}>
        ...
        <View style={{ marginTop: 80, alignItems: "center" }}>
          <Buttons handleSubmit={() => setShow(!show)} title={"Continue"} />
        </View>
      </View>
      <AlertBottomSheet
        isVisible={show}
        pressValidBtn={handleSubmit}
        pressBtn={() => setShow(!show)}
        onPress={() => setShow(!show)}
        title={"Delete Profile"}
        textbtn={"Confirm"}
        text={"Are you sure you want to delete this Profile?"}
        hide
        icons={<Trash size={24} color="black" />}
      />
      <AlertBottomSheet
        hidebtn
        isVisible={confirm}
        ...
        textbtn={"Confirm"}
        pressValidBtn={handleConfirm}
        text={"Account has been deleted succefuly"}
        hide
      />
    </View>
  );
